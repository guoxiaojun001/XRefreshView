...
public abstract class AbstractRvActivity extends Activity {
    ...
    protected List<User> getUsers() {
        ...
        for (int i=0; i<20; i++){
            ...
            int photoRes = 0;
            if(num == 0){
                photoRes = R.mipmap.one;
            }else if(num == 1){
                photoRes = R.mipmap.two;
            }else if(num == 2){
                photoRes = R.mipmap.three;
            }else if(num == 3){
                photoRes = R.mipmap.four;
            }
    ...
    protected abstract AbstractRvAdapter createAppAdapter(
    ...
    protected abstract class AbstractRvAdapter extends RecyclerView.Adapter {
        ...
        public void onBindViewHolder(final RecyclerView.ViewHolder vh, int position) {
            ...
            final SwipeHorizontalMenuLayout itemView =
                    (SwipeHorizontalMenuLayout) myViewHolder.itemView;
