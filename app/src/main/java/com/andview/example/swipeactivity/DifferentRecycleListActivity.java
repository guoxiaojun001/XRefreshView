...
public class DifferentRecycleListActivity extends AbstractRvActivity {
    ...
    @Override
    protected AbstractRvAdapter createAppAdapter(
            AbstractRvActivity baseRvActivity, List<User> users) {
    ...
    private class DifferentRvAppAdapter extends AbstractRvAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(
            ...
            if (viewType == VIEW_TYPE_SIMPLE) {
                ...
                View differentView = LayoutInflater.from(mContext).inflate(
                        R.layout.item_different, parent, false);
        ...
        private void fillDifferentView(DifferentViewHolder vh, final User user) {
            ...
            SwipeHorizontalMenuLayout itemView = (SwipeHorizontalMenuLayout)
                    differentViewHolder.itemView;
            differentViewHolder.tvName.setText(user.getUserName());
            itemView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Toast.makeText(mContext, "Hi " + user.getUserName(),
            ...
            differentViewHolder.btGood.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Toast.makeText(differentViewHolder.itemView.getContext(),
        ...
        private void fillSimpleView(final RecyclerView.ViewHolder vh, final User user) {
            ...
            final SwipeHorizontalMenuLayout itemView = (SwipeHorizontalMenuLayout)
            ...
            normalViewHolder.btGood.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Toast.makeText(normalViewHolder.itemView.getContext(),
                            "Good", Toast.LENGTH_SHORT).show();
                }
            });
            normalViewHolder.btOpen.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Toast.makeText(mContext, "Open " + user.getUserName(),
                            Toast.LENGTH_SHORT).show();
                }
            });
